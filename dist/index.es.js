...
import { useRef, useEffect, useState, forwardRef, useImperativeHandle, createElement, createContext, Children, useMemo, useContext, useCallback, useLayoutEffect } from 'react';
...
const CountDown = ({
  ...
  return jsx("div", {
    className: "countdown",
    children: eventDate > currentDate ? jsx("div", {
  ...
  const renderSchedule = () => {
    ...
    if (isSameDate && hasMultipleTimes) {
      return jsxs("div", {
        children: [jsx("div", {
          className: "schedule-time",
          children: convertedTimeSlots.map((time, index) => jsxs("span", {
        ...
        children: [jsxs("div", {
          ...
          children: [jsxs("div", {
            ...
            children: [jsxs("div", {
              ...
              className: "",
              children: ticket.cost === 0 ? "Free" : jsx(Fragment, {
                children: hasDiscount ? jsxs("div", {
                  className: "early-bird-prices",
                  children: [jsxs("h5", {
                    children: [currentCurrency === "USD" ? "$" : "₦", (ticket === null || ticket === void 0 ? void 0 : ticket.discountedCost) && Object.keys(rates).length > 0 ? jsx(Fragment, {
                    ...
                    children: [currentCurrency === "USD" ? "$" : "₦", (ticket === null || ticket === void 0 ? void 0 : ticket.cost) && Object.keys(rates).length > 0 ? jsx(Fragment, {
                  ...
                  children: (ticket === null || ticket === void 0 ? void 0 : ticket.cost) && Object.keys(rates).length > 0 ? jsx(Fragment, {
...
const SvgDropDown = props => jsx("svg", {
  xmlns: "http://www.w3.org/2000/svg",
  width: 16,
  height: 17,
  fill: "none",
      ...
      children: [jsxs("div", {
        ...
        children: [jsx("p", {
          ...
          children: [jsxs("div", {
            ...
            children: supportedCurrency.map((currency, idx) => jsx("li", {
    ...
    children: [jsx("h2", {
      ...
      return jsxs("div", {
        ...
        children: [jsxs("span", {
          ...
          children: ticket.cost === 0 ? "free" : jsxs(Fragment, {
...
`
      ...
      className: "divider"
    }), couponAppliedAmount > 0 && jsxs(Fragment, {
      children: [jsxs("div", {
        className: "summary-row",
        children: [jsx("span", {
          children: "Discount"
...
const SvgDollarIcon = props => jsxs("svg", {
  xmlns: "http://www.w3.org/2000/svg",
  ...
  return jsxs("div", {
    ...
    children: [jsx("label", {
      ...
      children: [jsx("div", {
        ...
        children: countryCodes.map((country, idx) => jsxs("li", {
...
const Tooltip = ({
  ...
  return jsxs("div", {
    ...
    children: [children, show && jsx("span", {
...
const TicketForm = ({
  ...
  const [appliedToggles, setAppliedToggles] = useState({});
  ...
  return jsx(Formik, {
    ...
    children: ({
      ...
      children: [jsx("div", {
        className: "",
        children: openPaymentsModal ? jsx("div", {
          className: "",
          children: jsx(Payment, {
          ...
          children: [jsxs("div", {
            ...
            children: [jsxs("div", {
            ...
            }), uniqueQuestions && (uniqueQuestions === null || uniqueQuestions === void 0 ? void 0 : uniqueQuestions.length) > 0 && jsxs("div", {
              ...
              children: [jsx("h3", {
                ...
                children: uniqueQuestions.map((q, i) => jsxs("div", {
                  className: "question-card",
                  children: [jsxs("label", {
                    children: [q.question, (q === null || q === void 0 ? void 0 : q.isRequired) === "True" && jsx("span", {
                      className: "",
                      children: "*"
                    })]
                  }), jsx(Field, {
            ...
            return jsxs("div", {
              ...
              children: [jsxs("div", {
                ...
                children: [jsxs("div", {
                  ...
                  children: [jsxs("strong", {
                    ...
                    children: [jsx(DeleteIcon, {}), jsx("span", {
                      children: "Delete"
                    })]
                  })]
                }), jsxs("div", {
              ...
              }), ((_a = ticket === null || ticket === void 0 ? void 0 : ticket.requiredQuestion) === null || _a === void 0 ? void 0 : _a.length) > 0 && jsxs("div", {
                className: "questions-container",
                children: [jsx("h3", {
                  className: "",
                  children: "Quick Questions"
                  ...
                  children: ticket.requiredQuestion.map((question, qIndex) => {
                    ...
                    return jsxs("div", {
                      className: "question-card",
                      children: [jsxs("label", {
                        children: [question.question, question.isRequired === "True" && jsx("span", {
                          children: "*"
                        })]
                      }), jsx(Field, {
                        name: fieldName,
                        placeholder: "Answer here"
                      }), isFirstOfType && jsxs("div", {
                            ...
                            children: [jsx("input", {
                              ...
                              children: jsx("span", {
                                ...
                                children: jsx("span", {
                                  ...
                                  children: !!appliedToggles[question.id] ? jsx(ToggleSwitchOn, {
                                    width: "1rem",
                                    height: ".8rem"
                                  }) : jsx(CancelIcon, {})
                                })
            ...
            children: [jsx("div", {
              ...
              children: [jsxs("div", {
                ...
                children: [jsx(Field, {
                  ...
                  children: showApplyCoupon ? jsx("div", {
      ...
      }), openPaymentsModal ? jsxs("div", {
        className: "ctn-container",
        children: [jsx("div", {
          onClick: handleClosePayment,
          className: "go-back-btn",
          children: "Back"
        }), isSubmitting ? jsx("div", {
          className: "loading-btn",
          children: jsx("div", {
            className: "loader-spinner"
          })
...
const Checkout = ({
  ...
  var _a, _b, _c;
  const [tickets, setTickets] = useState(listedTickets);
  ...
  const [discountCode, setDiscountCode] = useState(isTicketSupportAutoDis === true ? defaultCoupon === null || defaultCoupon === void 0 ? void 0 : defaultCoupon.code : "");
  useEffect(() => {
...
const EventDetails = ({
  ...
  return jsxs(Modal, {
    ...
    openPaymentsModal: openPaymentsModal,
    children: [showTicketPurchaseSuccess ? jsx(TicketPurchaseSuccessfulModal, {
      close: handleClose,
      BASE_URL: BASE_URL,
      buttonColor: buttonColor
    }) : jsx(Fragment, {
      children: openCheckout ? jsx(Fragment, {
        children: jsx(Checkout, {
          rates: rates,
          coupons: coupons,
        ...
        }), eventDetails && Object.keys(eventDetails).length > 0 && jsxs("div", {
...
const GruveEventWidgets = ({
  ...
  const [eventDetailsWithId, setEventDetailsWithId] = useState(null);
